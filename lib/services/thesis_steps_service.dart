...
class ThesisStepsService {
  List<ThesisStep> getThesisSteps() {
    return [
      ThesisStep(
          title: "1. Пријава",
          validator: "ментор",
      ...
      ThesisStep(
          title: "2. Прифаќање на темата од студентот",
          validator: "Студент",
          description:
      ...
      ThesisStep(
          title: "4. Одобрување за оценка од ментор",
          validator: "ментор",
          description:
      ...
      ThesisStep(
          title: "6. Валидирање на услови за одбрана",
          validator: "Студентска служба",
          description:
